...
public class GoodsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewholder.iv_pic = (SimpleDraweeView) convertView.findViewById(R.id.iv_pic);
        ...
        if (list.get(position).getIcon() != null) {
            ...
            viewholder.iv_pic.setImageURI(Uri.parse(list.get(position).getIcon()));
        }
        ...
        viewholder.iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int count = ((StoreDetailsActivity) context).getSelectedItemCountById(list.get(position).getProduct_id());
                ...
                ((StoreDetailsActivity) context).handlerCarNum(1, list.get(position), true);
                catograyAdapter.notifyDataSetChanged();
...
//                ((StoreDetailsActivity) context).setAddAnim(v, position);// 开始执行饿了么动画
        ...
        viewholder.iv_remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((StoreDetailsActivity) context).handlerCarNum(0, list.get(position), true);
                catograyAdapter.notifyDataSetChanged();
...
//                    catograyAdapter.notifyDataSetChanged();
//                  ((StoreDetailsActivity)context).showDetailSheet(list.get(position).getPackage_product_info(),list.get(position).getTitle());
//                }else{
